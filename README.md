...
**[Download PDF](https://github.com/ykirpichev/llm-book/releases/download/public-2026-09-23/engineering-large-language-models.pdf)** · **[Download source](https://github.com/ykirpichev/llm-book/releases/download/public-2026-09-23/engineering-large-language-models-source.zip)** · **[Release notes](https://github.com/ykirpichev/llm-book/releases/tag/public-2026-09-23)**
...
**Public Edition - September 2026.** Seventy chapters across nine parts, with worked examples, original diagrams, runnable CPU references, and design exercises. Part VII revised through **September 23, 2026**; the other parts retain their September 13 research cutoff unless explicitly dated. [What changed in Part VII](docs/part7-update-2026-09-23.md).
...
The **[public edition release](https://github.com/ykirpichev/llm-book/releases/tag/public-2026-09-23)** includes the PDF, editable source, and [SHA-256 checksums](https://github.com/ykirpichev/llm-book/releases/download/public-2026-09-23/SHA256SUMS). No account or payment is required to read or download the book. Build it locally with `make book`, or create all release assets with `make release`. See the [release evidence](docs/release-readiness.md) and [publication instructions](docs/publishing.md). Earlier draft releases are historical checkpoints with their original notices.
