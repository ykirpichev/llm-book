...
Checked September 7, 2026. This ledger covers the highlighted recent-result
numbers and the shared running-model arithmetic. It does not certify every
...
| RocketKV: up to 3x decode, 31% lower peak memory | [Paper](https://arxiv.org/abs/2502.14051) | H100; full-KV baseline and evaluated long-context tasks. Not lossless attention. |
