...
The assets are written to `output/release/public-2026-09-24-experiments/`:
...
Preserve the original `public-2026-09` release. Create a new GitHub Release with tag `public-2026-09-24-experiments` pointing to the published
source commit. Use the prepared [release notes](release-notes-public-2026-09-24-experiments.md)
