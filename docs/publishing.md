...
The assets are written to `output/release/public-2026-09/`:
...
Create a GitHub Release with tag `public-2026-09` pointing to the published
source commit. Use the prepared [release notes](release-notes-public-2026-09.md)
