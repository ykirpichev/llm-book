...
The assets are written to `output/release/public-2026-09-24-part7/`:
...
Preserve the original `public-2026-09` release. Create a new GitHub Release with tag `public-2026-09-24-part7` pointing to the published
source commit. Use the prepared [release notes](release-notes-public-2026-09-24-part7.md)
